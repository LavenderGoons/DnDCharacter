...
public class CharacterManager {
    ...
    public void loadCharacter(Long id) {
        this.characterId = checkNotNull(id);
...
/*
    ...
    public void setSimpleCharacter(SimpleCharacter simpleCharacter) {
        writeToDatabase(DatabaseHelper.COLUMN_CHARACTER, gson.toJson(simpleCharacter));
    ...
    private synchronized void readCharacterAbilities() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_ABILITIES, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_ABILITIES));
    ...
    public void setCharacterAbilities(Abilities abilities) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_ABILITIES, gson.toJson(abilities));
    }
    ...
    private synchronized void readCharacterArmor() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_ARMOR, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_ARMOR));
    ...
    public void setCharacterArmor(ArrayList<Armor> armorList) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_ARMOR, gson.toJson(armorList));
    }
    ...
    private synchronized void readCharacterAttacks() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_ATTACK, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_ATTACK));
                if (json != null && !Utils.isStringEmpty(json) && !json.equals("[]") && !json.equals("[ ]")) {
    ...
    public void setCharacterAttacks(ArrayList<Attack> attacks) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_ATTACK, gson.toJson(attacks));
    }
    ...
    private synchronized void readCharacterAttributes() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_ATTRIBUTES, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_ATTRIBUTES));
                if (json != null && !Utils.isStringEmpty(json) && !json.equals("[]") && !json.equals("[ ]")) {
    ...
    public void setCharacterAttributes(ArrayList<String> attributes) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_ATTRIBUTES, gson.toJson(attributes));
    }
    ...
    private synchronized void readCharacterFeats() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_FEATS, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_FEATS));
                if (json != null && !Utils.isStringEmpty(json) && !json.equals("[]") && !json.equals("[ ]")) {
    ...
    public void setCharacterFeats(ArrayList<Feat> feats) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_FEATS, gson.toJson(feats));
    }
    ...
    private synchronized void readCharacterItems() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_ITEM_GENERAL, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_ITEM_GENERAL));
                if (json != null && !Utils.isStringEmpty(json) && !json.equals("[]") && !json.equals("[ ]")) {
    ...
    public void setCharacterItems(ArrayList<Item> items) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_ITEM_GENERAL, gson.toJson(items));
    }
    ...
    private void readCharacterNotes() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_NOTES, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_NOTES));
                if (json != null && !Utils.isStringEmpty(json) && !json.equals("[]") && !json.equals("[ ]")) {
    ...
    public void setCharacterNotes(ArrayList<Note> notes) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_NOTES, gson.toJson(notes));
    }
    ...
    private synchronized void readCharacterSkills() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_SKILL, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_SKILL));
                if (json != null && !Utils.isStringEmpty(json)) {
    ...
    public void setCharacterSkills(ArrayList<Skill> skills) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_SKILL, gson.toJson(skills));
    }
    ...
    private synchronized void readCharacterSpells() {
        if (dbAdapter != null && characterId != -1) {
            Cursor cursor = dbAdapter.getColumnCursor(DatabaseHelper.COLUMN_SPELL, characterId);
            if (cursor != null) {
                String json = cursor.getString(cursor.getColumnIndex(DatabaseHelper.COLUMN_SPELL));
                if (json != null && !Utils.isStringEmpty(json) && !json.equals("[]") && !json.equals("[ ]")) {
    ...
    public void setCharacterSpells(ArrayList<Spell> spells) {
        ...
        //TODO Move to AsyncTask
        writeToDatabase(DatabaseHelper.COLUMN_SPELL, gson.toJson(spells));
    }
